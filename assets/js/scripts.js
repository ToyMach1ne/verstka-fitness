...
//     $orderButton.removeClass('header-form-opened');
//     $(this).removeClass('super-button-opened')
//     $('.close').removeClass('close-order--show')
//   } else {
//     $orderButton.addClass('header-form-opened');
...
$('.footer-btn').on('click', function(e) {
    e.preventDefault();
    $('.footer-form').addClass('footer-form-opened')
})
$('.close-order--show').on('click', function(e) {
    e.preventDefault();
    $('.footer-form').removeClass('footer-form-opened')
...
window.onload = function() {
    tabContent = document.getElementsByClassName('single-tab-content');
    tab = document.getElementsByClassName('tab-item');
    hideTabsContent(1);
}
...
function hideTabsContent(a) {
    for (var i=a; i<tabContent.length; i++) {
        ...
        tab[i].classList.remove('fist-tab');
    }
}
